...
POSITIVE_WORDS_WEIGHTED = {
    "большой": 0.02, "просторный": 0.02, "светлый": 0.02, "уютный": 0.02, "теплый": 0.02, "комфортный": 0.02, "тихий": 0.02,
    "отличный": 0.02, "красивый": 0.02, "хороший": 0.02, "ухоженный": 0.02, "ремонт": 0.02, "видеонаблюдение": 0.02, "изолированный": 0.02,
    "необходимый": 0.02, " красивый": 0.02, "красивый": 0.02, "красивый": 0.02, "солнечный": 0.02, "раздельный": 0.02, "качественный": 0.02,
...
categories = {
    "ремонт": ["капитальный", "новый", "евроремонт", "косметический"],
    "мебель": ["меблированный", "шкаф", "диван", "кухня", "стол"],
    "техника": ["холодильник", "стиральный", "кондиционер", "плита"],
    "район": ["центр", "спальный", "тихий", "оживлённый"],
    "транспорт": ["метро", "остановка", "транспорт", "развязка"],
    "условия": ["долгосрочная", "залог", "депозит", "собственник"]
}
...
def suggest_expansion(text):
    ...
    if len(words) < 30:  # Проверяем длину текста
        return "Ваше описание довольно короткое. Добавьте больше информации о ремонте, мебели, транспорте или удобствах рядом."

    return "Описание достаточно подробное!"
